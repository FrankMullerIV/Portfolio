...
/**
 * Manages barcode scanning and product lookup logic
 * Includes camera initialization, barcode processing using ML Kit
 * and async API call to OpenFoodFacts for product details
 */
public class BarcodeManager {
    ...
    /**
     * Performs an async HTTP GET request to OpenFoodFacts
    ...
    public static void lookupProductName(String barcode, ProductResultCallback callback) {
        new Thread(() -> {
            try {
                String urlString = "https://world.openfoodfacts.org/api/v2/product/" + barcode;
